...
exports.parseBasePrice = parseBasePrice;
exports.normalizeRole = normalizeRole;
exports.parseBoolean = parseBoolean;
exports.parsePlayersCSV = parsePlayersCSV;
...
function normalizeRole(raw) {
    ...
    if (s === "batsman" || s === "batter" || s === "bat")
        return "Batter";
    if (s === "bowler" || s === "bowl")
        return "Bowler";
    if (s === "allrounder" || s === "ar" || s === "all-rounder")
        return "All-Rounder";
    if (s === "wicketkeeper" || s === "wk" || s === "wicket-keeper" || s === "wicketkeeperbatter")
        return "Wicketkeeper";
    return null;
}
// ============================================================
...
function parsePlayersCSV(csvText) {
    ...
    for (let i = 1; i < lines.length; i++) {
        ...
        if (!seenSets.includes(setVal))
            seenSets.push(setVal);
